...
function Navbar() {
  ...
  // Top bar ke messages ki list jo slide/change honge
  const messages = [
    "🛍️ Shop for Rs. 2,999 or More & Enjoy FREE Delivery Across Pakistan! 🚚",
    "💎 Explore Our Exclusive Luxury Jewellery Collection 💎",
    "📲 Follow Us on Instagram & TikTok: @operaofficialpk"
  ];
  
  const [currentMsg, setCurrentMsg] = useState(0);

  // Har 3 seconds ke baad message change hoga (Slider effect)
  useEffect(() => {
  ...
  return (
    <header className="sticky top-0 z-50">
      {/* Top Black Announcement Sliding Bar */}
      <div className="bg-black text-white text-xs py-2 px-4 text-center font-medium tracking-wider overflow-hidden">
